...
const register = new _worker_utils_register_worker__WEBPACK_IMPORTED_MODULE_2__["RegisterWorker"]();
register.handleMessages((graphData) => {
...
function calculateLayout(subject, graphData) {
    setTimeout(() => {
        const simulation = Object(d3_force__WEBPACK_IMPORTED_MODULE_0__["forceSimulation"])(graphData.nodes)
            .force('link', Object(d3_force__WEBPACK_IMPORTED_MODULE_0__["forceLink"])(graphData.links).id((d) => d.id.toString()).distance(0).strength(1))
            ...
            .force('collide', Object(d3_force__WEBPACK_IMPORTED_MODULE_0__["forceCollide"])().radius((d) => d.r + 3));
