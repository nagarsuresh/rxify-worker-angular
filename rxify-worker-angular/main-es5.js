...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.calculateLayout = function (grpahData) {
        var _this = this;
        var rxify = new _worker_utils_rxify_worker__WEBPACK_IMPORTED_MODULE_2__["RxifyWorker"](new Worker(__webpack__worker__1, {  }));
        this.subscription = rxify.sendMessage(this.graphData).subscribe(function (result) {
            _this.progressValue = result.progress;
            if (result.progress === 100) {
                _this.drawGraph(result);
            }
        });
    };
    AppComponent.prototype.prepareData = function () {
        for (var i = 0; i < 3000; i++) {
            this.graphData.nodes.push({ id: i, r: 3 });
            var from = Math.round(Math.cbrt(i));
            var to = i;
    ...
    AppComponent.prototype.drawGraph = function (graphData) {
        var context = this.graphEl.nativeElement.getContext('2d');
 ...
 *
 */
var RxifyWorker = /** @class */ (function () {
    ...
    RxifyWorker.prototype.sendMessage = function (payload) {
    ...
    RxifyWorker.prototype.handleMessageEvent = function (event) {
    ...
    RxifyWorker.ctorParameters = function () { return [
        { type: Worker }
    ]; };
    return RxifyWorker;
}());
