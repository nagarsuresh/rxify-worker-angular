...
/* harmony import */ var _worker_utils_register_worker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./worker-utils/register-worker */ "./src/app/worker-utils/register-worker.ts");



var register = new _worker_utils_register_worker__WEBPACK_IMPORTED_MODULE_2__["RegisterWorker"]();
register.handleMessages(function (graphData) {
    var subject = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
    calculateLayout(subject, graphData);
    return subject.asObservable();
});
function calculateLayout(subject, graphData) {
    setTimeout(function () {
        var simulation = Object(d3_force__WEBPACK_IMPORTED_MODULE_0__["forceSimulation"])(graphData.nodes)
            .force('link', Object(d3_force__WEBPACK_IMPORTED_MODULE_0__["forceLink"])(graphData.links).id(function (d) { return d.id.toString(); }).distance(0).strength(1))
            .force('charge', Object(d3_force__WEBPACK_IMPORTED_MODULE_0__["forceManyBody"])().strength(-40))
            .force('x', Object(d3_force__WEBPACK_IMPORTED_MODULE_0__["forceX"])())
            .force('y', Object(d3_force__WEBPACK_IMPORTED_MODULE_0__["forceY"])())
            .force('collide', Object(d3_force__WEBPACK_IMPORTED_MODULE_0__["forceCollide"])().radius(function (d) { return d.r + 3; }));
...
/***/ "./src/app/worker-utils/register-worker.ts":
/*!*************************************************!*\
  !*** ./src/app/worker-utils/register-worker.ts ***!
  \*************************************************/
 ...
 * ```
 */
var RegisterWorker = /** @class */ (function () {
     ...
     */
    RegisterWorker.prototype.handleMessages = function (handler) {
        this.handler = handler;
    };
    /**
     * handles incoming message and sends response back
     */
    RegisterWorker.prototype.handleIncomingMessages = function () {
        var _this = this;
        self.addEventListener('message', function (event) {
            ...
            // next handler
            function (data) {
                var messageToSend = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, message, { __messageType: 'DATA', userData: data });
                // @ts-ignore
            ...
            // complete handler
            function () {
                var messageToSend = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, message, { __messageType: 'COMPLETE' });
                // @ts-ignore
                self.postMessage(messageToSend);
                // subscription.unsubscribe();
            });
